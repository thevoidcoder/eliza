...
export class DirectClient {
    ...
    constructor() {
        ...
        this.app.get("/smallchat/:text", async (req, res) => {
            const agentId = "ae17b46d-720c-00a4-8b0f-c96b433a0951";
            const runtime = this.agents.get(agentId);
            const fek = "";
            // get all ids
            console.log(Array.from(this.agents.keys()));
            ...
            // Use normal chat implementation
            try{
                await runtime.ensureConnection(
                    userId,
                    roomId,
